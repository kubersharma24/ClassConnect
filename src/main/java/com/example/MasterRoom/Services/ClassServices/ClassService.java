...
public interface ClassService {
    ...
    GetClassRoomWithHandlerIdResponseDTO getClassRoomWithClassCode(GetClassRoomWithClassCodeRequestDTO request);

    DeleteClassResponseDTO deleteClassWithClassCode(GetClassRoomWithClassCodeRequestDTO request);
}
